...
public class InventoryExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleConflict(DuplicateInventoryException ex, HttpServletRequest request) {
        return problem(
                HttpStatus.CONFLICT,
    ...
    public ProblemDetail handleInsufficientInventory(InsufficientInventoryException ex, HttpServletRequest request) {
        return problem(
