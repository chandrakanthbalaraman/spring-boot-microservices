...
Dense **notebook** 1:1 slides (same teaching density as [`../reference/exception-handling/`](../reference/exception-handling/)). Landscape architecture poster stays next to this folder: [`../phase-1.png`](../phase-1.png).
